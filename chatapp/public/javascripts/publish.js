...
socket.on('receiveMessageEvent', function (message, userName, dateString) {
    ...
    $('#thread').prepend('<div class="incoing_msg" id="' + id + '_div"><div class="received_msg"><div class="received_with_msg"><p>' + message + '</p><span class="time_date">' + dateString + '</span></div></div></div>');
});
